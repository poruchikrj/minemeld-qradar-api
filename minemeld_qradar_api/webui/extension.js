console.log('Loading QRadar API Output WebUI');
...
angular.module('minemeld_qradar_api', [])
    .controller()
    .config(['$stateProvider', function($stateProvider) {
        $stateProvider.state('nodedetail.msftisgoutputinfo', {
            templateUrl: '/extensions/webui/minemeld_qradar_api/isg.output.info.html',
            controller: 'NodeDetailInfoController',
            controllerAs: 'vm'
        });
    }])
    .run(['NodeDetailResolver', '$state', function(NodeDetailResolver, $state) {
        NodeDetailResolver.registerClass('minemeld_qradar_api.node.Output', {
            tabs: [{
                icon: 'fa fa-circle-o',
                tooltip: 'INFO',
